 ...
 *
 * Note:
 * - Do not include this header together with <fmt/std.h> if your fmt version
 *   already provides std::optional support; you will get a duplicate specialization.
...
namespace fmt {
      ...
      * @tparam Char Character type (char or wchar_t).
      * @since 1.0
      */
    template <typename T, typename Char>
    struct formatter<std::optional<T>, Char> : formatter<T, Char> {
        // Provide a clear diagnostic if T is not formattable with this Char.
